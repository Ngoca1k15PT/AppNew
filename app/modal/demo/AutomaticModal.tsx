          ...
          Component: () => (
            <View
              ...
              <Text
                ...
                This is a nice image in here! Wait there is another modal!
              </Text>
            </View>
          ),
        }),
          ...
          Component: () => (
            <View
              ...
              <Text
                ...
                This is the Third Dialog. No More dialogs
              </Text>
            </View>
          ),
        }),
  ...
  return (
    <View
      ...
      <Text
        ...
        This is the First Dialog. Please wait next dialog will be shown in a bit
      </Text>
    </View>
  );
};
